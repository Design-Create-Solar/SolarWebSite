...
import { Field, Radio, Dropzone, Button } from "../MultiplePages/GFXElems";
import "./Blocks.css";
  ...
  useEffect(() => {
    ...
    for (const block of blocks) {
      ...
      for (const img of block.images)
        tmp.push(
          `https://elasticbeanstalk-us-west-2-127661128201.s3-us-west-2.amazonaws.com/${img}`
        );
