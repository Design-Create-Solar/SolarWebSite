...
const InfoArea = (props) =>{
    ...
    return (<ContainerDark flexDirection={props.align==="left"?"row":"row-reverse"} backgroundColor="red">
        <TextArea >
...
return (<ContainerLight flexDirection={props.align==="left"?"row":"row-reverse"} backgroundColor="red">
    <TextArea >
        <Typography variant = "h5">{props.header}</Typography>
        <Typography variant = "body1">{props.text}</Typography>
    </TextArea>
