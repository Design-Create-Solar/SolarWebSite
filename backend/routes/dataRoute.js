...
router.post('/addAcc', (req, res) => {
  ...
  writeApi
      ...
      .catch(e => {
          console.error(e)
          console.log('\naccelerometer point write ERROR')
      })
  res.json(point);
})
...
router.get("/query/last24hr", (req, res) => {
  ...
  queryApi.queryRows(fluxQuery, {
    ...
    error(error) {
      console.error(error)
      console.log(`\nERROR: 24 Hr ${req.query.type} Query`)
    },
    complete() {
...
router.get("/query", (req, res) => {
  ...
  queryApi.queryRows(fluxQuery, {
    ...
    error(error) {
      console.error(error)
      console.log(`\nERROR: Custom Time Range ${req.query.type} Query`)
    },
    complete() {
